...
public class BudgetWarningStrategy implements AlertStrategy{
    ...
    @Autowired
    public BudgetWarningStrategy(TransactionRepository transactionRepository,AlertRepository alertRepository,BudgetRepository budgetRepository,SseEmitterService sseEmitterService){
