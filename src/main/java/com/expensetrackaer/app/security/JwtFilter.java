...
public class JwtFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        try {
            ...
            // Invalid token format — reject silently, Spring Security will return 401
            filterChain.doFilter(request, response);
            return;
        }
        ...
        if (email != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            if (jwtUtil.isTokenValid(jwt, userDetails.getUsername())) {
                ...
                // Extract userId from token and store as credentials
                // This is what SecurityUtils.getCurrentUserId() reads
                Long userId = jwtUtil.extractUserId(jwt);

                UsernamePasswordAuthenticationToken authToken =
                        new UsernamePasswordAuthenticationToken(
                                userDetails,
                                userId,              // ← userId stored here as credentials
